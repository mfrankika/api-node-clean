...
describe('SignUp Controller', () => {
  test('Should return 400 no name is provided', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
  ...
  test('Should return 400 no email is provided', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Should return 400 no password is provided', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Should return 400 no password Confirmation is provided', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
